var OneTrustStub = ((t) => {
  ...
  ((v.prototype.initConsentSDK = function () {
    ...
    (v.prototype.getLocation = function (t) {
      ...
      i.OneTrust && i.OneTrust.geolocationResponse
        ? ((i = i.OneTrust.geolocationResponse),
          ...
          this.addBannerSDKScript(t))
        : (i = this.readCookieParam(c.optanonCookieName, c.geolocationCookiesParam)) ||
            t.SkipGeolocation
          ? ((e = i.split(';')[0]),
            (i = i.split(';')[1]),
    ...
    (v.prototype.getRegionSet = function (t) {
      ...
      for (
        var r = a.state.toLowerCase(), s = a.country.toLowerCase(), u = 0;
        u < t.RuleSet.length;
        u++
      )
      ...
      c.stubScriptElement && c.stubScriptElement.hasAttribute(c.DATAFILEATTRIBUTE)
        ...
        : t
          ...
          : c.stubScriptElement ||
            ...
            c.stubScriptElement &&
              ((c.isMigratedURL = !0), (this.domainId = c.migratedDomainId.trim())));
    }),
    (v.prototype.setDomainDataFileURL = function () {
      ...
      (t &&
        (c.isMigratedURL
          ...
          : (c.storageBaseURL = (
              e ? t.split('/consent') : t.split('/scripttemplates/' + c.stubFileName)
            )[0])),
    ...
    (v.prototype.updateVersion = function (t) {
      ('debug' !== this.buildType && 'cybuild' !== this.buildType) || (t.Version = '202507.1.0');
    }));
  var y = v;
  function v() {
    var s = this;
      ...
      (this.addBannerSDKScript = function (r) {
        return e(s, void 0, void 0, function () {
          ...
          return u(this, function (t) {
            switch (t.label) {
              case 0:
                return ((e = this.getRegionSet(r)).GCEnable ||
                  ...
                  : '5.11.0' === r.Version
                    ? (c.isMigratedURL &&
                      ...
                      c.storageBaseURL +
                        ...
                        c.bannerScriptName)
                    : (c.isMigratedURL &&
                        (i.src = c.storageBaseURL + '/scripttemplates/' + c.stubFileName + '.js'),
                      c.storageBaseURL +
                        '/scripttemplates/' +
                        r.Version +
                        '/' +
