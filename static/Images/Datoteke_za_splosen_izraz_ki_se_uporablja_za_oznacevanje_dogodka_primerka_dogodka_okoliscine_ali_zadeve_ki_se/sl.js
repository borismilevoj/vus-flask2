!(function (t) {
  ...
  function (t, e, n) {
    ...
    var i = {
      get: function (t) {
        for (
          var e = t + '=', n = decodeURIComponent(document.cookie), i = n.split(';'), o = 0;
          o < i.length;
          o++
        ) {
          var u = i[o].trim();
  ...
  function (t, e, n) {
    ...
    var o = n(0),
      ...
      r = 'slireg',
      s = function (t, e) {
        ((this.tid = t), (this.globalUrl = e || 'https://scout.salesloft.com'));
      };
    ((s.prototype = {
      get: function (t) {
        var e = this,
        ...
        return n
          ? t(this.globalUrl, n)
          : i(this.globalUrl + '/r?tid=' + encodeURIComponent(this.tid), function (n) {
              t(e.globalUrl, n);
            });
      },
    }),
  ...
  function (t, e, n) {
    ...
    ((u.prototype = {
      fetchGuid: function (t) {
        ...
        if (n && i) ((this.guid = n), t(this.guid));
        else {
      ...
      get: function () {
        return (
          o.default.get('sliguid')
            ? (this.guid = o.default.get('sliguid'))
            : ((this.guid = this.generate()), o.default.set('sliguid', this.guid, 365)),
          this.guid
        );
      },
    }),
    ...
    ((i.prototype = {
      ...
      getEncodedParams: function (t) {
        ...
        for (var n in this.definitions) {
          ...
          i !== this.SKIP_PARAMETER &&
            ('' != e && (e += '&'), (e += n + '=' + encodeURIComponent(i)));
        }
        return e;
      },
      getType: function (t) {
      ...
      incrementSessionCount: function () {
        return ((this.sessionCount += 1), this.sessionCount);
      },
  ...
  function (t, e, n) {
    ...
    function u(t) {
      (A.indexOf(t) > -1 && (E.unidentified = !1), O.indexOf(t) > -1 && (I.unidentified = !1));
    }
    function r(t) {
      if (t) {
    ...
    function s(t) {
      var e = x;
      return (
        C.getToken() !== C.SKIP_PARAMETER && (e = U),
        encodeURI(e) + '?' + C.getEncodedParams({ type: t })
      );
    }
    function d(t, e) {
    ...
    var h = n(3),
      ...
      b = 6e5,
      A = [
        'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJ0IjoxMDgzOX0.LSz4FYiDsjCaYCCySTzXCsafgDXfEr0gEbeGaMn7qtc',
      ],
      O = A,
      E = { identified: !0, unidentified: !1 },
      I = { identified: !0, unidentified: !1 },
      C = new p.default(
        (function () {
          var t = m.default.get('sbrc'),
            e = T.default.get('sli_token');
          return t ? (T.default.set('sli_token', t, 30), t) : e;
        })()
      ),
      k = {
        init: function (t, e) {
