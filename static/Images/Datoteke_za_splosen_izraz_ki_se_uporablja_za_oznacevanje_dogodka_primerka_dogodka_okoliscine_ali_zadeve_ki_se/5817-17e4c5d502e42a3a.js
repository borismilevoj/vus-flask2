!(function () {
  try {
    ...
    t &&
      ...
      (e._sentryDebugIds[t] = '4b2215ed-e18b-4e76-abc4-e03c99fa65d2'),
      (e._sentryDebugIdIdentifier = 'sentry-dbid-4b2215ed-e18b-4e76-abc4-e03c99fa65d2'));
  } catch (e) {}
})();
('use strict');
      ...
      let [y, v] = (0, a.b)('Tooltip', [s.D7]),
        ...
        D = (0, o.forwardRef)((e, t) => {
          let { __scopeTooltip: n, ...a } = e,
            ...
            d = m(n),
            p = (0, o.useRef)(null),
            g = (0, i.e)(t, p, u.onTriggerChange),
            h = (0, o.useRef)(!1),
            b = (0, o.useRef)(!1),
            y = (0, o.useCallback)(() => (h.current = !1), []);
          return (
                  ...
                  a,
                  {
                    ...
                    onPointerMove: (0, l.M)(e.onPointerMove, (e) => {
                      'touch' === e.pointerType ||
                        ...
                        (u.onTriggerEnter(), (b.current = !0));
                    }),
                    onPointerLeave: (0, l.M)(e.onPointerLeave, () => {
                      (u.onTriggerLeave(), (b.current = !1));
                    }),
                    onPointerDown: (0, l.M)(e.onPointerDown, () => {
                      ((h.current = !0), document.addEventListener('pointerup', y, { once: !0 }));
                    }),
                    onFocus: (0, l.M)(e.onFocus, () => {
                      h.current || u.onOpen();
                    }),
                    onBlur: (0, l.M)(e.onBlur, u.onClose),
                    onClick: (0, l.M)(e.onClick, u.onClose),
                  }
                )
              )
            )
        ...
        M = 'TooltipPortal',
        [R, L] = y(M, { forceMount: void 0 }),
        P = 'TooltipContent',
        I = (0, o.forwardRef)((e, t) => {
          let n = L(P, e.__scopeTooltip),
            { forceMount: l = n.forceMount, side: i = 'top', ...a } = e,
            u = _(P, e.__scopeTooltip);
          return (0, o.createElement)(
            p.z,
            { present: l || u.open },
            u.disableHoverableContent
              ? (0, o.createElement)(A, (0, r.Z)({ side: i }, a, { ref: t }))
              : (0, o.createElement)(O, (0, r.Z)({ side: i }, a, { ref: t }))
          );
        }),
        O = (0, o.forwardRef)((e, t) => {
          let n = _(P, e.__scopeTooltip),
            l = E(P, e.__scopeTooltip),
            a = (0, o.useRef)(null),
            u = (0, i.e)(t, a),
            [c, s] = (0, o.useState)(null),
            { trigger: d, onClose: p } = n,
            f = a.current,
            { onPointerInTransitChange: g } = l,
            h = (0, o.useCallback)(() => {
              (s(null), g(!1));
            }, [g]),
            b = (0, o.useCallback)(
          ...
          return (
              ...
              if (c) {
                let e = (e) => {
                  let t = e.target,
                    ...
                    r =
                      (null == d ? void 0 : d.contains(t)) || (null == f ? void 0 : f.contains(t)),
                    o = !(function (e, t) {
                      let { x: n, y: r } = e,
                        o = !1;
            ...
            (0, o.createElement)(A, (0, r.Z)({}, e, { ref: u }))
          );
        }),
        [Z, H] = y(C, { isInside: !1 }),
        A = (0, o.forwardRef)((e, t) => {
          ...
          return (
            (0, o.useEffect)(
              () => (document.addEventListener(x, h), () => document.removeEventListener(x, h)),
              [h]
            ),
            (0, o.useEffect)(() => {
              if (p.trigger) {
            ...
            (0, o.createElement)(
              ...
              (0, o.createElement)(
                s.VY,
                (0, r.Z)({ 'data-state': p.stateAttribute }, f, d, {
                  ref: t,
                  style: {
                    ...d.style,
                ...
                (0, o.createElement)(g.A4, null, l),
                (0, o.createElement)(
                  Z,
                  { scope: n, isInside: !0 },
                  (0, o.createElement)(b.f, { id: p.contentId, role: 'tooltip' }, i || l)
                )
              )
            )
          );
        ...
        B = (0, o.forwardRef)((e, t) => {
          let { __scopeTooltip: n, ...l } = e,
            i = m(n);
          return H('TooltipArrow', n).isInside
            ? null
            : (0, o.createElement)(s.Eh, (0, r.Z)({}, i, l, { ref: t }));
        }),
        z = (e) => {
          let {
              __scopeTooltip: t,
        ...
        Y = (e) => {
          let {
            ...
            b = (0, c.M)(),
            y = (0, o.useRef)(0),
            v = null != a ? a : d.disableHoverableContent,
            ...
            M = (0, o.useMemo)(
              () => (k ? (_.current ? 'delayed-open' : 'instant-open') : 'closed'),
              [k]
            ),
            R = (0, o.useCallback)(() => {
              (window.clearTimeout(y.current), (_.current = !1), D(!0));
            }, [D]),
            L = (0, o.useCallback)(() => {
              ...
              (0, o.createElement)(
                T,
                {
                  ...
                  onTriggerLeave: (0, o.useCallback)(() => {
                    v ? L() : window.clearTimeout(y.current);
                  }, [L, v]),
                  onOpen: R,
                  onClose: L,
        ...
        F = D,
        S = (e) => {
          let { __scopeTooltip: t, forceMount: n, children: r, container: l } = e,
            i = _(M, t);
          return (0, o.createElement)(
            R,
            ...
            (0, o.createElement)(
              p.z,
              { present: n || i.open },
              (0, o.createElement)(d.h, { asChild: !0, container: l }, r)
            )
          );
        },
        V = I,
