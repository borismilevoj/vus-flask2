(function () {
  ...
  r('Promise', function (a) {
    ...
    b.prototype.A = function (h, g) {
      if (this.h != 0)
        throw Error(
          'Cannot settle(' + h + ', ' + g + '): Promise already settled in state' + this.h
        );
      this.h = h;
      this.i = g;
      this.h === 2 && this.L();
    ...
    b.race = function (h) {
      return new b(function (g, k) {
        for (var l = x(h), m = l.next(); !m.done; m = l.next()) d(m.value).B(g, k);
      });
    };
    b.all = function (h) {
      var g = x(h),
      ...
      return k.done
        ...
        : new b(function (l, m) {
            ...
            var w = [],
              A = 0;
            do (w.push(void 0), A++, d(k.value).B(u(w.length - 1), m), (k = g.next()));
            while (!k.done);
          });
    };
    return b;
      ...
      if (m && F(g[0], l))
        for (g = 0; g < m.length; g++) {
          ...
          if ((k !== k && u.key !== u.key) || k === u.key)
            return { id: l, list: m, index: g, entry: u };
        }
    ...
    if (
      (function () {
        ...
        try {
          ...
          e = f.next();
          return e.done || e.value[0] == c || e.value[0].x != 4 || e.value[1] != e.value[0]
            ? !1
            : f.next().done;
        } catch (h) {
          return !1;
  ...
  r('Array.from', function (a) {
    return a
      ...
      : function (b, c, d) {
          ...
          } else for (e = b.length, h = 0; h < e; h++) f.push(c.call(d, b[h], h));
          return f;
        };
  }); /*
...
*/
  ...
  n.G = function (a, b) {
    ...
    if (c) {
      ...
      if (this.A) for (e = 0; e < c.length; e++) ((f = c[e]), jb(this.g[f + 1], this.g[f + 2], d));
      else {
        this.m++;
        try {
  ...
  function mb(a, b, c) {
    if (Array.isArray(b)) for (var d = 0; d < b.length; d++) mb(a, String(b[d]), c);
            ...
            Promise.all(
              b.map(function (d) {
                ...
                return oa(function (e) {
                  ...
                  e.g != 2
                    ? ((f = e.m), f.state === 'prompt' && a.g.push(d), (e.g = 0), (e.l = 0))
    ...
    if (W.yt_embedsEnableIframeSrcWithIntent) {
      ...
      a: if (((e = e === void 0 ? Ua : e), c instanceof K)) e = c;
        ...
        for (f = 0; f < e.length; ++f)
          if (((a = e[f]), a instanceof Ta && a.S(c))) {
            e = new K(c);
            break a;
          }
        e = void 0;
  ...
  function Mb(a) {
    if (a.tagName.toLowerCase() !== 'iframe') {
      var b = vb(a, 'videoid');
      b && ((b = { videoId: b, width: vb(a, 'width'), height: vb(a, 'height') }), new X(a, b));
    }
  }
  function Hb(a, b, c) {
    Z ||
          ...
          if (e && d.origin === e.O)
            switch (
              ...
              case 'apiInfoDelivery':
                if (H(f)) for (var h in f) f.hasOwnProperty(h) && (d.v[h] = f[h]);
                break;
              case 'infoDelivery':
                Jb(d, f);
                break;
              case 'initialDelivery':
                ...
                break;
              default:
                d.j.i || ((h = { target: d, data: f }), d.j.G(e, h), wb('player.' + e, h));
            }
        }
      }));
    Z[b] = { U: a, O: c };
